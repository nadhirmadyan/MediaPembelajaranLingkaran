...
<div>
  <div class="nav_list">
    <a href="index.html" class="nav_link ${getChapChild(
      ...
      <i class="fa-solid fa-house nav_icon"></i> <span class="nav_name"><b>Beranda</b></span>
    </a>
    <a href="daftar-nilai.html" class="nav_link ${getChapChild(
      "/teachers/pages/daftar-nilai.html"
    )}">
      <i class="fa-solid fa-list-check nav_icon"></i> <span class="nav_name"><b>Daftar Nilai</b></span>
    </a>
    <a href="kkm.html" class="nav_link ${getChapChild("/teachers/pages/kkm.html")}">
      <i class="fa-solid fa-circle-check nav_icon"></i> <span class="nav_name"><b>KKM</b></span>
    </a>
  </div>
</div>
